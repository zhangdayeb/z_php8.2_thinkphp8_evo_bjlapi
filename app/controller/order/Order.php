...
use think\facade\Db;
use think\facade\Queue;  // 需要添加这行
use app\job\ZongHeMoneyJob;  // 需要添加这行
...
class Order extends OrderBase
{
    ...
    public function user_bet_order(): string
    {
        ...
        $data['money_balance'] = self::$user['money_balance'] - $dec_money + $delBetMoney;      // 返回给前端展示数据标注
